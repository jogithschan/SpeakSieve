...
def run(input_string,path_to_audio="audio_files/original_audio.mp3", path_to_csv = "transcript-word.csv", path_to_transcript = "transcript.csv"):
    ...
    audio_name = f"{path_to_audio[:-4]}_bleeped.wav"
